...
namespace NCRFiscalManager.Infraestructure.Migrations
{
    ...
    partial class NCRFiscalContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("NCRFiscalManager.Core.Entities.EmitterInVoice", b =>
                {
                    ...
                    b.ToTable("EmitterInVoice", (string)null);
                });
            ...
            modelBuilder.Entity("NCRFiscalManager.Core.Entities.PointOnSale", b =>
                {
                    ...
                    b.Property<string>("ResolutionSerial")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.ToTable("PointOnSales", (string)null);
                });
            ...
            modelBuilder.Entity("NCRFiscalManager.Core.Entities.TechOperator", b =>
                {
                    ...
                    b.ToTable("TechOperators", (string)null);
                });
            ...
            modelBuilder.Entity("NCRFiscalManager.Core.Entities.TechOperatorEmitterInVoice", b =>
                {
                    ...
                    b.ToTable("TechOperatorEmitterInVoice", (string)null);
                });

            modelBuilder.Entity("NCRFiscalManager.Core.Entities.BlackListItems", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                ...
                b.Property<string>("AlohaItemCode")
                    .IsRequired()
                    .HasMaxLength(50)
                    .HasColumnType("nvarchar(50)");

                b.Property<string>("AlohaItemName")
                    .HasMaxLength(100)
                    .HasColumnType("nvarchar(100)");

                b.Property<long>("EmitterInVoiceId")
                    .HasColumnType("bigint");
