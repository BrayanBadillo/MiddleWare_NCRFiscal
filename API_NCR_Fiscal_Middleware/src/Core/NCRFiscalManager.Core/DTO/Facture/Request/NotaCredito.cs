...
{
    [XmlElement("Cabecera")]
    public CabeceraCrediNoteDTO Cabecera { get; set; }

    [XmlElement("ReferenciasNotas")]
    public ReferenciasNotasDTO ReferenciasNotas { get; set; }

    [XmlElement("FacturasRelacionadas")]
    public FacturasRelacionadasDTO FacturasRelacionadas { get; set; }
